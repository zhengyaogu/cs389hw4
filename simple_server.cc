...
private:
    ...
    process_request()
    {
        ...
        case http::verb::get:
            ...
            try
            {
                if (key.at(0) != '/') {response_.result(400); break;}
            }
            catch(int e)
            {
            ...
            if (val == nullptr) {response_.result(404); break;}
        ...
        case http::verb::put:
            ...
            try
            {
                if (key_value.at(0) != '/') {response_.result(400); break;}
            }
            catch(int e)
            {
                response_.result(400);
            ...
            if (delim_pos == std::string::npos) {response_.result(400); break;}
        ...
        case http::verb::head:
            {json pair;
            pair["Space-Used"] = cache_->space_used();
            beast::ostream(response_.body()) << pair.dump();
            response_.version(11);
            response_.set(http::field::accept, "text/html");
